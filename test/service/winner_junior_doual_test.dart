...
void main() {
  group('JuniorDualWinnerService Tests with Fake Firestore', () {
    ...
    // 1 වන ටෙස්ට් එක: Junior 1st, 2nd, 3rd ස්ථාන වලට dualId එක සාර්ථකව සෙට් වෙනවාද බැලීම
    test(
    ...
    // 3 වන ටෙස්ට් එක: Streams (getJuniorFirstPlace) හරහා නිවැරදිව රියල්-ටයිම් ඩේටා ලැබෙනවාද බැලීම
    test(
